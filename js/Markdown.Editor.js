...
(function () {
    ...
    var defaultsStrings = {
        bold: "加粗  Ctrl+B",
        boldexample: "在这里输入需要加粗字体",

        italic: "斜体 Ctrl+I",
        italicexample: "在这里输入斜体",

        link: "超链接 <a> Ctrl+L",
        linkdescription: "enter link description here",
        linkdialog: "<p><b>超链接</b></p><p>http://example.com/ \"optional title\"</p>",
        ...
        image: "图片 <img> Ctrl+G",
        imagedescription: "添加图片描述",
        imagedialog: "<p><b>插入图片</b></p><p>http://example.com/images/diagram.jpg \"optional title\"<br><br>Need <a href='http://www.google.com/search?q=free+image+hosting' target='_blank'>free image hosting?</a></p>",
    ...
    function PreviewManager(converter, panels, previewRefreshCallback) {
        ...
        var makePreviewHtml = function () {
            ...
            // 同步到预览窗口后美化代码片段
            var preEles = panels.preview.getElementsByTagName("pre");
            var codeEles = panels.preview.getElementsByTagName("code");
            for (var i = 0; i < codeEles.length; i++) {
                if (!hljs) {
                    throw new Error("hljs plugin must load...");
                } else {
